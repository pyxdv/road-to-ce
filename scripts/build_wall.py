...
<!--
  ข้อสอบปลายภาค · 5 นาที · 10 คะแนน
  ขอบเขต Mission 0 กับ Mission 1 เท่านั้น ไม่มี ping ไม่มี nslookup ไม่มีคำนวณระยะทาง

  อ่านสามอย่างนี้พอ
  1. ใบความรู้หัวข้อ 11 - อะไรห้ามขึ้นที่สาธารณะ และทำไม
  2. ใบความรู้หัวข้อ 8  - ทำไม tagline กว้าง ๆ ถึงใช้ไม่ได้
  3. ใบงาน Mission 1   - ชื่อ repository ที่ทำให้เว็บขึ้นที่ URL ระดับบนสุด สะกดยังไง

  คุณเจอข้อความนี้เพราะกดดูซอร์ส
  สิ่งที่ไม่แสดงผล ไม่ได้แปลว่าไม่มีใครเห็น
  จำประโยคนี้ไว้ให้ดี วันสอบจะได้ใช้
-->
<html lang="th">
<head>
<meta charset="utf-8">
